...
class CNN_LSTMClassifier(pl.LightningModule):
...
if __name__ == '__main__':
    # model = CNN_LSTMClassifier(in_dim=8, hidden_size=32, num_layers=3, dropout=0.1, n_classes=2, bidirectional=True)
    # model = LSTMClassifier(in_dim=8, hidden_size=32, num_layers=3, dropout=0.1, n_classes=2, bidirectional=True)
    model =  LSTMClassifier(in_dim=5, hidden_size=32, num_layers=4, dropout=0.1, n_classes=2, bidirectional=True)
    dummy = torch.zeros(1, 5, 19200)
    out = model(dummy)
