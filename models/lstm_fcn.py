# https://github.com/renqi1/Time_Series_Classification/blob/main/MLSTM_FCN.py
...
class LSTM_FCN(nn.Module):
    ...
    def forward(self, x):
        # input x : [B, F, T], where B = Batch size, F = features, T = Time samples
...
if __name__ == "__main__":
    model = LSTM_FCN(Batch_Size=128, N_Features=9, N_ClassesOut=2)
    dummy = torch.zeros(16, 9, 192) # [B, C, seq_len]
    out = model(dummy)
