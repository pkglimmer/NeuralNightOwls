...
https://github.com/dthiagarajan/ptb-xl-research/blob/master/core/models/resnet.py
"""
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_input_channels=3, num_classes=1000,
                 ...
                 replace_stride_with_dilation=None, norm_layer=nn.BatchNorm1d, return_feature = False):
        ...
        layer4_channels = 64
        self.layer4 = self._make_layer(block, layer4_channels, layers[3], stride=2,
                                       dilate=replace_stride_with_dilation[2])
        self.z_projector = nn.Linear(75, 64) # MSG: 120, BCM: 75
        self.avgpool = nn.AdaptiveAvgPool1d(1)
        self.fc = nn.Linear(layer4_channels * block.expansion, num_classes)
...
def main():
    ...
    model = resnet18(num_input_channels=6, num_classes=2)
    # model = model_ResNet(layers=[2,2,2,2], num_classes=5)
    dummy = torch.randn((10, 6, 3000)) # PTB-XL
